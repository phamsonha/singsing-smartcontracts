...
contract LootBox is ILootBox, ERC721 {
    ...
    constructor(
        ...
        classDropRates[0] = 80; // box = 0 (Bronze) , mic = 0 (Bronze)
        classDropRates[1] = 19; // box = 0 (Bronze) , mic = 1 (Silver)
        classDropRates[2] = 1;  // box = 0 (Bronze) , mic = 2 (Gold)
        classDropRates[3] = 0;  // box = 0 (Bronze) , mic = 3 (Diamond)
        classDropRates[4] = 0;  // box = 0 (Bronze) , mic = 4 (Platinum)
        classDropRates[5] = 6; // box = 1 (Silver) , mic = 0 (Bronze)
        classDropRates[6] = 82; // box = 1 (Silver) , mic = 1 (Silver)
        classDropRates[7] = 9; // box = 1 (Silver) , mic = 2 (Gold)
        classDropRates[8] = 3;  // box = 1 (Silver) , mic = 3 (Diamond)
        classDropRates[9] = 0;  // box = 1 (Silver) , mic = 4 (Platinum)
        classDropRates[10] = 0; // box = 2 (Gold) , mic = 0 (Bronze)
        classDropRates[11] = 6; // box = 2 (Gold) , mic = 1 (Silver)
        classDropRates[12] = 82; // box = 2 (Gold) , mic = 2 (Gold)
        classDropRates[13] = 9; // box = 2 (Gold) , mic = 3 (Diamond)
        classDropRates[14] = 3; // box = 2 (Gold) , mic = 4 (Platinum)
        classDropRates[15] = 0; // box = 3 (Diamond) , mic = 0 (Bronze)
        classDropRates[16] = 0; // box = 3 (Diamond) , mic = 1 (Silver)
        classDropRates[17] = 10; // box = 3 (Diamond) , mic = 2 (Gold)
        classDropRates[18] = 80; // box = 3 (Diamond) , mic = 3 (Diamond)
        classDropRates[19] = 10; // box = 3 (Diamond) , mic = 4 (Platinum)
        ...
        classDropRates[23] = 12; // box = 4 (Platinum) , mic = 3 (Diamond)
        classDropRates[24] = 88; // box = 4 (Platinum) , mic = 3 (Platinum)
